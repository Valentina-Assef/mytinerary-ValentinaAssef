    ...
    <>
      <header className='flex justify-center items-center text-center'>
        ...
        <div className="search-bar w-[70%] md:w-[50%] lg:w-[25%] mt-64 md:mt-56 rounded-full absolute bg-white py-0.5 pr-0.5 pl-2.5">
          <form role="search" className="flex items-center justify-between pl-5" onSubmit={(e) => e.preventDefault()}>
            <input onKeyDown={handleKeyPress} ref={inputSearch} id="searchInput" type="text" placeholder="Search" aria-label="Search" className="w-[50%] outline-none"/>
