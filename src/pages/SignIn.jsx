...
export default function SignIn() {
  return (
    <div className="img_signIn flex justify-center items-center text-center">
      <div className="border-gray-200 border-2 flex flex-wrap rounded-lg bg-white w-[678px] max-w-[75vw] md:max-w-[90vw] md:min-h-[400px] md:max-h-[400px] mt-32 md:mt-24 mb-10 form-shadow">
        <div className="bg-white  md:w-1/2 w-full px-3 md:px-5 rounded-lg">
          <FormSignIn />
        </div>
        <div className="bg-red-500 text-white md:w-1/2 w-full flex flex-col justify-center items-center p-5 rounded-b-lg md:rounded-bl-none md:rounded-tr-lg md:rounded-br-lg">
