...
export default function SignUp() {
  return (
    <section className="flex justify-center items-center text-center">
      ...
      <div className="absolute flex flex-wrap-reverse md:flex-nowrap bg-white rounded-lg w-[60vw] max-w-[90vw] h-[75vh] mt-20 form-shadow">
        <div className="text-white md:w-1/2 p-5 form-color bg-red-500 flex flex-col justify-center items-center rounded-tl-lg rounded-bl-lg" >
