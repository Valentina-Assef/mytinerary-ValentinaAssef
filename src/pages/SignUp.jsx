...
export default function SignUp() {
  return (
    <div className="img_signUp flex justify-center items-center text-center">
      <div className="border-gray-200 border-2 flex flex-wrap-reverse rounded-lg bg-white max-w-[80vw] md:max-w-[70vw] lg:max-w-[65vw] md:min-h-[400px] mt-32 md:mt-24 mb-10 form-shadow">
        <div className="bg-red-500 text-white md:w-1/2 w-full flex flex-col justify-center items-center p-5 rounded-b-lg md:rounded-br-none md:rounded-tl-lg md:rounded-bl-lg">
