  ...
  return (
    <div className='nav h-20 shadow-md w-full fixed top-0 left-0 bg-white opacity-80'>
        <div className='md:flex items-center justify-between py-0 md:px-10 px-7'>
          ...
          <ul className={`md:flex md:items-center md:pb-0 pb-12 pr-5 absolute md:static bg-white md:z-auto z-[-1] left-0 w-full md:w-auto md:pl-0 pl-9 transition-all duration-500 ease-in ${open ? "top-20 opacity-100" : "top-[-490px] md:opacity-100 opacity-0"}`}>
            {
              Links.map((Link) => (
